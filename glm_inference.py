...
model_path = '/mnt/cachenew/sunyuhan/models/chatglm2-6b'
...
def create_dataset():
    ...
    if rank == 0:
        for li in gathered_li:
            final_li += li
        file_path = "/mnt/cachenew/sunyuhan/alpaca-lora/glm/syh_short_alpaca.json"
        # Write the list of dictionaries to the JSON file
        import json
        with open(file_path, 'w') as json_file:
            json.dump(final_li, json_file)
...
def create_cot_dataset():
    ...
    if rank == 0:
        for li in gathered_li:
            final_li += li
        file_path = "/mnt/cachenew/sunyuhan/alpaca-lora/glm/syh_cot_alpaca.json"
        # Write the list of dictionaries to the JSON file
        import json
        with open(file_path, 'w') as json_file:
            json.dump(final_li, json_file)
...
def create_qa_dataset():
    ...
    if rank == 0:
        ...
        for li in gathered_li:
            final_li += li
        file_path = "/mnt/cachenew/sunyuhan/alpaca-lora/glm/wiki-trivia-qa-noref.json"
        # Write the list of dictionaries to the JSON file
        import json
        with open(file_path, 'w') as json_file:
            json.dump(final_li, json_file)
...
def lora():
    ...
    file_path = "/mnt/cachenew/sunyuhan/alpaca-lora/alpha_exp1006.json"
    # Write the list of dictionaries to the JSON file
    import json
    with open(file_path, 'w') as json_file:
        json.dump(results, json_file)
